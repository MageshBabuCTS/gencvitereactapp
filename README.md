...
## Step 1
Install the  below  dependencies to  write  unit test cases 

```
npm install -D vitest @testing-library/jest-dom @testing-library/react @testing-library/user-event jsdom
```

for  code  coverage  vitest  uses  v8  enine  by default [Vitest dev  guide](https://vitest.dev/guide/coverage.html#coverage-setup)
```
